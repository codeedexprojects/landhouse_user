...
export default function MessageList() {
  ...
  const messageData = [
    { 
      name: "praveen", 
      contactInfo: "9969696590 / pravee9@gmail.com", 
      property: "Single Family Residency, 4 Cent", 
      message: "Hi, I'm really intre" 
    },
    { 
      name: "praveen", 
      contactInfo: "9969696590 / pravee9@gmail.com", 
    ...
    <div className="bg-blue-50 min-h-screen p-4">
      ...
      <div className="bg-white rounded-md shadow-sm mb-6 overflow-hidden">
        ...
        {messageData.map((row, index) => (
          <div key={index} className="grid grid-cols-4 gap-2 p-4 border-b">
            <div className="text-gray-500">{row.name}</div>
            <div className="text-gray-500">{row.contactInfo}</div>
            <div className="text-blue-500">{row.property}</div>
            <div className="flex items-center">
              <span className="text-gray-500">{row.message}</span>
