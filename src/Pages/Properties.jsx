...
const Properties = () => {
  return (
    <div className="px-4 py-8 md:px-12 lg:px-24 bg-white">
      {/* Heading */}
      ...
      <input
        ...
        className="w-300 px-4 py-3 border rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-indigo-500"
      />
  ...
  {properties.map((property) => (
    <div
      key={property.id}
      className="border rounded-lg shadow-sm overflow-hidden w-full max-w-[360px] mx-auto" style={{border:"1px solid white" , borderRadius:"2px", backgroundColor:"#E7F1FF"}}
    >
      {/* Image (reduced height) */}
      <img
        src={property.image}
        alt={property.title}
        className="w-full h-36 object-cover" // reduced from h-48
      />

      {/* Details (tighter spacing) */}
