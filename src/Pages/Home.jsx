  ...
  return (
    <div>
      ...
      <div className="bg-white mt-[-70px] relative z-0">
        {/* Banner */}
        <div
          className="relative w-full h-[650px] mb-12 rounded-xl overflow-hidden"
          data-aos="fade-up"
        >
          {/* Background Image */}
          ...
          <div className="absolute inset-0 bg-opacity-40 flex items-center px-8 md:px-16">
            <div
              className="text-[#3A7EDD] max-w-md mt-52"
              data-aos="fade-right"
              data-aos-delay="200"
            >
              <h2
              ...
              <p
                className="text-sm md:text-base mb-5 mt-5"
                data-aos="fade-up"
                data-aos-delay="600"
              >
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-3xl">
            Each property design has its own meaning, and we're ready to help
            you get a property that matches your taste.
          </p>
        </div>
            ...
            <div className="bg-white p-6 rounded-xl max-w-md w-full relative shadow-xl">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mb-4">
                  Share this property with friends
                </p>
              </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-8 py-8 overflow-hidden">
              ...
              >
                ...
                <p className="text-gray-800 text-lg mb-8">
                  We offer a range of servicing including buying, selling, and
                  property management.
                </p>
              ...
              <div className="flex flex-col md:flex-row justify-between gap-8">
                ...
                <div className="md:w-1/2 text-[#03004D]" data-aos="fade-right">
                  <h2 className="text-5xl font-bold mb-6">
                    Why Landouse is Your Best Choice
                  </h2>
                  <p className="leading-relaxed text-lg">
                    Finding the perfect property can be overwhelming, but
                    Landouse makes the journey seamless and stress-free. Our
                    secure platform offers transparency, convenience, and
                    personalized features that help you make informed decisions
                    with confidence.
                  </p>
                </div>
                ...
                <div className="md:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <p className="text-base text-gray-600">
                      Safe and reliable property-buying experience by listing
                      only verified properties from trusted sellers.
                    </p>
                  </div>
                  ...
                  <div
                    className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center col-span-1 md:col-span-2"
                    data-aos="zoom-in"
                  >
                    <div className="bg-indigo-900 p-2 rounded-full mb-4">
                      <svg
                    ...
                    <p className="text-base text-gray-600">
                      Get expert guidance on loan options and financing for your
                      dream property.
                    </p>
                  </div>
                </div>
          ...
          <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-between">
            ...
            >
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-700 mb-8 max-w-md">
                Discover the ideal property that suits your needs and lifestyle.
                Start your journey to the perfect home today!
              </p>
              <button
                onClick={handleContactClick}
                className="cursor-pointer bg-blue-500 hover:bg-blue-600 text-white py-3 px-8 text-base sm:text-lg rounded transition duration-300"
              >
                Contact Now
              </button>
            </div>
            ...
            <div
              className="md:w-1/2 p-4 md:p-0 mt-8 md:mt-0 relative flex justify-center"
              data-aos="fade-left"
              data-aos-delay="400"
            >
