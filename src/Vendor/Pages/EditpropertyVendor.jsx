...
function EditpropertyVendor() {
  ...
  const handleEdit = async (e) => {
    ...
    try {
      ...
      const response = await EditPropertyVendorAPI(property._id, formDataToSend);

      if (response?.data?.success) {
        toast.success("Property updated successfully!");
        setTimeout(() => {
          navigate("/vendor/view-property"); // Changed to vendor route
        }, 2000);
      } else {
  ...
  return (
    <div className="p-4 bg-blue-100 min-h-screen">
      {/* Form Card - Removed the breadcrumb and heading section */}
